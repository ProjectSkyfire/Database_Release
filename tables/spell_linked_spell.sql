...
-- Dumping structure for table sf_master.spell_linked_spell
...
-- Dumping data for table sf_master.spell_linked_spell: 253 rows
...
INSERT INTO `spell_linked_spell` (`spell_trigger`, `spell_effect`, `type`, `comment`) VALUES
	...
	(91847, 74100, 0, 'Life Savings: Teleport & Bind to the Lost Isles'),
	(115546, 118635, 0, 'Provoke'),
