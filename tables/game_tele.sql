...
-- Dumping structure for table sf_master.game_tele
...
CREATE TABLE IF NOT EXISTS `game_tele` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1526 DEFAULT CHARSET=utf8 COMMENT='Tele Command';

-- Dumping data for table sf_master.game_tele: 1,524 rows
...
INSERT INTO `game_tele` (`id`, `position_x`, `position_y`, `position_z`, `orientation`, `map`, `name`) VALUES
	...
	(211, -1354.53, -2737.5, 58.9458, 5.9114, 0, 'CircleOfOuterBiding'),
	(210, -1539.11, -2168.63, 17.3715, 0.578985, 0, 'CircleOfInnerBindindg'),
	...
	(195, -8658.39, 746.877, 96.825, 0.646923, 0, 'CathedralSquare'),
	(194, -8583.63, 805.724, 106.519, 0.660715, 0, 'CathedralOfLight'),
	...
	(72, -6712.91, -3350.91, 241.254, 1.01048, 0, 'Badlands'),
	...
	(66, 4023.99, -5888.25, 114.119, 2.9839, 1, 'Azshara'),
	...
	(9, -2020.72, -2107.58, 91.9626, 5.49717, 1, 'FieldsOfBlood'),
	...
	(318, -8394.21, 606.628, 94.6108, 1.15148, 0, 'DwarvenDistrict'),
	...
	(367, 9041.51, -7456.05, 83.385, 3.11721, 530, 'FarstriderRetrear'),
	...
	(427, -5143.53, 894.909, 287.394, 2.26833, 0, 'Gnomeregan'),
	...
	(442, -4080.6, -3463.16, 273.276, 0.690672, 0, 'GrimBatol'),
	...
	(532, -6692.48, -2175.31, 283.453, 0.427571, 0, 'Kargath'),
	...
	(568, -5172.04, -2952.93, 336.993, 6.20809, 0, 'LochModan'),
	...
	(696, -8728.45, 409.289, 97.7728, 3.80528, 0, 'OldTown'),
	...
	(703, 1569.97, -4397.41, 16.0472, 0.543025, 1, 'Orgrimmar'),
	...
	(871, 878.74, 1359.33, 53.05, 5.89929, 0, 'SilverpineForest'),
	...
	(913, -853.221, -533.529, 9.98556, 0.242866, 0, 'RuinsOfSouthshore'),
	...
	(945, 1570.92, 1031.52, 138.276, 3.33006, 1, 'StonetalonMountains'),
	...
	(949, -9477.04, -3353.42, 27.419, 1.65792, 0, 'StonewatchFalls'),
	...
	(954, -8833.07, 622.778, 93.9317, 0.6771, 0, 'Stormwind'),
	...
	(1259, -9574.83, -924.954, 100.272, 3.13119, 1, 'Uldum'),
	...
	(1394, 4488.76, 5736.18, 80.0769, 5.45078, 571, 'BorgorokOutpost'),
	(1395, 3071.85, 4791.19, 1.13476, 5.76654, 571, 'Kaskala'),
	(1396, 2925.02, 4065.63, 1.46737, 3.56739, 571, 'Unupe'),
	(1397, 3464.17, 4087.16, 17.0561, 2.02607, 571, 'TaunkaleVillage'),
	...
	(1403, 5560.23, -3211.66, 371.709, 5.55055, 571, 'ZulDrak'),
	...
	(1408, -8379.79, 253.323, 155.347, 5.38782, 0, 'StormwindKeep'),
	...
	(1521, 8515.63, 714.174, 558.248, 1.57298, 571, 'TrialOfTheCrusader'),
	(1522, 8588.42, 791.888, 558.236, 3.23819, 571, 'TrialOfTheChampion'),
	(1523, 3001.38, -542.47, 248.18, 5.1, 870, 'Pandaria'),
	(1524, 3826.87, 1795.74, 950.352, 0.299085, 870, 'PeakOfSerenity'),
	(1525, 800.708, -343.901, 400.784, 2.22925, 870, 'BlackmarketAuction'),
