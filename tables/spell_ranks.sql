...
-- Dumping structure for table sf_master.spell_ranks
...
CREATE TABLE IF NOT EXISTS `spell_ranks` (
  ...
  `spell_rank` tinyint unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`first_spell_id`,`spell_rank`),
  UNIQUE KEY `spell_id` (`spell_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='Spell Rank Data';

-- Dumping data for table sf_master.spell_ranks: 132 rows
