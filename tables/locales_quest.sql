...
-- Dumping structure for table sf_master.locales_quest
...
CREATE TABLE IF NOT EXISTS `locales_quest` (
  ...
  `QuestGiverTextWindow_loc11` text,
  ...
  `QuestGiverTargetName_loc11` text,
  ...
  `QuestTurnTextWindow_loc11` text,
  ...
  `QuestTurnTargetName_loc11` text,
  PRIMARY KEY (`Id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

-- Dumping data for table sf_master.locales_quest: 0 rows
